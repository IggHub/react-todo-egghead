...
test('toggleTodo should not mutate the old object', () => {
  const startTodo = {id: 2, name: 'two', isComplete: false}
  const result = {id: 2, name: 'two', isComplete: true}

  expect(result).not.toBe(startTodo);
})

test('updateTodo should update item by id', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: false},
    {id: 3, name: 'three', isComplete: false}
...
test('updateTodo should not mutate original array', () => {
  ...
  const result = updateTodo(startTodos, 2)
